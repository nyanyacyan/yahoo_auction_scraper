...
class PriceCalculator:
    ...
    CT_PATTERN = re.compile(r'(?:ct\s*([0-9.]{1,5})|([0-9.]{1,5})\s*ct)')
    ...
    def extract_carat(cls, title: str) -> float:
        ...
        # 正規表現のグループ1またはグループ2から値を取得（どちらかに数値が入る）
    ...
    def calculate_price_per_carat(
        ...
        try:
            ...
            raw_price_per_carat = price / carat
